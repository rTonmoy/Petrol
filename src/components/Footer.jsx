        ...
        <div className='max-w-container mx-auto '>
            <div className="flex flex-wrap lg:justify-between">
                <div className="lg:w-[40%] w-full">
                    <div className="">
                    <img className='lg:pl-[0px] pl-[80px]' src={logo6} alt="" />
                    <ul className='px-[80px] lg:px-[0px]'>
            ...
            <div className="flex gap-x-2 pt-[32px] lg:mx-[0px] mx-[110px]">
                <div className="flex items-center className='text-white w-[25px] h-[25px] rounded-[50%] bg-[#F40404]">
