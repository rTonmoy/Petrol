...
const Banner = () => {
  return (
    <div className='bg-banbg bg-no-repeat bg-cover bg-center  py-[30px] lg:py-[200px] z-[10] relative after:absolute after:top-0 after:left-0 after:content-[""] after:w-full after:h-full after:bg-[rgba(0,0,0,0.6)] after:z-[-10]'>
